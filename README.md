...
<p align="center">
    <i>
        ...
        На данный момент работаю в должности Backend-разработчик ООО "Агрегейт".<br> Держу свой "ускоритель интернета".<br> Занимаюсь личными веб-проектами на Go<br>
    </i><br>
</p>
...
[![QWEN](https://img.shields.io/badge/qwen-6247eb?logo=qwen&logoColor=white&style=for-the-badge)](https://github.com/seelentov)
